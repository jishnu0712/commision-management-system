<header class="main-header">
   <div class="d-flex align-items-center logo-box justify-content-start">
      ...
      <a href="/" class="logo p-0">
         <!-- logo-->
         <div class="logo-lg">
            <span class="light-logo"><img src="{{ asset('assets/images/fnlogo.png') }}" width="180" alt="logo"></span>
            <span class="dark-logo"><img src="{{ asset('assets/images/fnlogo.png') }}" width="180" alt="logo"></span>
         </div>
      </a>
   </div>
   <!-- Header Navbar -->
   ...
   <section class="sidebar">
      <div class="user-profile px-20 pt-15 pb-10">
         <div class="d-flex align-items-center">
            <div class="image">
               <img src="{{ asset('storage/profile_pic/' . auth()->user()->profile_pic) }}" class="avatar avatar-lg bg-primary-light rounded100" alt="User Image">
            </div>
            <div class="info">
               <a class="px-20" href="#">
         ...
         <ul class="list-inline profile-setting mt-20 mb-0 d-flex justify-content-between">
            ...
            <li><a href="{{ route('logout') }}" data-toggle="tooltip" data-placement="top" title="Logout"><i data-feather="log-out"></i></a></li>
         </ul>
      </div>
      <!-- sidebar menu-->
      <ul class="sidebar-menu" style="overflow-y: scroll !important; height: 70vh !important;" data-widget="tree">
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ route('user.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>All Users</a></li>
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ route('department.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>All Department</a></li>
               <li><a href="{{ route('department.create') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Add Department</a></li>
            </ul>
         </li>
         <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ route('doctor.index') }}"><i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>All Doctors</a></li>
