    ...
    <section class="sidebar">
        <div class="user-profile px-20 pt-15 pb-10">
            ...
            <ul class="list-inline profile-setting mt-20 mb-0 d-flex justify-content-between">
                ...
                <li><a href="{{ route('logout') }}" data-toggle="tooltip" data-placement="top" title="Logout"><i
        ...
        <ul class="sidebar-menu" style="overflow-y: scroll !important; height: 70vh !important;" data-widget="tree">
            ...
            @if (in_array('users_view', $userPermission) || in_array('users_add', $userPermission))
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        @if (in_array('users_view', $userPermission))
                            <li><a href="{{ route('user.index') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>All Users</a></li>
                        @endif

                        @if (in_array('users_add', $userPermission))
                            <li><a href="{{ route('user.create') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Add User</a></li>
                        @endif
                    </ul>
                </li>
            @endif

            @if (in_array('department_view', $userPermission) || in_array('department_add', $userPermission))
                <li class="treeview">
                    <a href="#">
                        <i class="icon-Thunder-move"><span class="path1"></span><span class="path2"></span></i>
                    ...
                    <ul class="treeview-menu">
                        @if (in_array('department_view', $userPermission))
                            <li><a href="{{ route('department.index') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>All Department</a>
                            </li>
                        @endif

                        @if (in_array('department_add', $userPermission))
                            <li><a href="{{ route('department.create') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Add Department</a>
                            </li>
                        @endif
                    </ul>
                </li>
            ...
            @if (in_array('doctor_view', $userPermission) || in_array('doctor_add', $userPermission))
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        @if (in_array('doctor_view', $userPermission))
                            <li><a href="{{ route('doctor.index') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>All Doctors</a></li>
                        @endif

                        @if (in_array('doctor_add', $userPermission))
                            <li><a href="{{ route('doctor.create') }}"><i class="icon-Commit"><span
                                            class="path1"></span><span class="path2"></span></i>Add Doctor</a></li>
                        @endif
                    </ul>
                </li>
            @endif
