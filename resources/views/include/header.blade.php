          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
               <li><a href="{{ route('department.index') }}"><i class="icon-Commit"><span class="path1"></span><span
                  class="path2"></span></i>All Department</a></li>
               <li><a href="{{ route('department.create') }}"><i class="icon-Commit"><span class="path1"></span><span
                  class="path2"></span></i>Add Department</a></li>
            </ul>
         </li>
       </ul>
