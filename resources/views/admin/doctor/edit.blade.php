                                    ...
                                    <div class="box-body">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="{{ $doctor->email }}" type="text" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Doctor Email">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="{{ $doctor->specialization }}" type="text" name="specialization" class="form-control @error('specialization') is-invalid @enderror" placeholder="Doctor Specialization">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input value="{{ $doctor->hospital_name }}" type="text" name="hospital_name" class="form-control @error('hospital_name') is-invalid @enderror" placeholder="Hospital Name">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea rows="5" class="form-control" required name="address" placeholder="address">{{ $doctor->address }}</textarea>
