                                        ...
                                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="doctor_name"
                                                    value="{{ request('doctor_name') }}" class="form-control"
                                                    placeholder="Doctor Name" />

                                                <label>Hospital Name</label>
                                                <input type="text" name="hospital_name"
                                                    value="{{ request('hospital_name') }}" class="form-control"
                                                    placeholder="Doctor Name" />
                                            </div>
                                                ...
                                                @foreach ($doctors as $key => $doctor)
                                                    <tr>
                                                        <td data-title="Sl No">
                                                            <a href="javascript:;">
                                                                <button type="button"
                                                                    class="waves-effect waves-light btn btn-primary btn-sm">{{ $key + 1 }}</button>
                                                            </a>
                                                        </td>
                                                        <td data-title="img">
                                                            <img class="rounded" width="35px" height="35px" alt="Profile pic"
