                                    ...
                                    <div class="box-body">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                maxlength="10"
                                                required placeholder="Mobile" value="{{ $user->mobile }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9"><input type="password" step="any" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password - (If you want to change)">
